...
export const TRANSLATIONS: Record<LangKey, Record<string, TranslationValue>> = {
  es: {
    tabShelves: 'Estanterías',
    tabSearch: 'Buscar',
    tabExplore: 'Explorar',
    exploreSearch: 'Buscar una película...',
    exploreNoResults: 'Sin resultados',
    exploreConnections: (n: number) => `${n} conexión${n === 1 ? '' : 'es'}`,
    exploreNoConnections: 'No hay conexiones en el grafo para esta película',
    exploreBack: 'Atrás',
    exploreLoading: 'Cargando conexiones...',
    exploreHint: 'Busca una película para explorar sus conexiones en el grafo de conocimiento',
    exploreScreening: 'En cartelera',
    ...
    csvStep1: 'Desde un navegador (no la app), ve a <a href="https://letterboxd.com/settings/data/" target="_blank">letterboxd.com/settings/data</a>',
    ...
    sortByRating: 'Ord. por nota',
    sortByMatch: 'Ord. por afinidad',
    ...
    lbSignInAction: 'Inicia sesión',
    lbSignInSuffix: 'para subir tus datos y recibir recomendaciones personalizadas.',
    filmCount: (n: number) => `${n} película${n !== 1 ? 's' : ''}`,
    calendarHint: 'Haz clic en cualquier póster para ver sesiones, entradas y opciones de calendario',
  ...
  en: {
    ...
    tabSearch: 'Search',
    tabExplore: 'Explore',
    exploreSearch: 'Search a film...',
    exploreNoResults: 'No results',
    exploreConnections: (n: number) => `${n} connection${n === 1 ? '' : 's'}`,
    exploreNoConnections: 'No graph connections found for this film',
    exploreBack: 'Back',
    exploreLoading: 'Loading connections...',
    exploreHint: 'Search a film to explore its connections in the knowledge graph',
    exploreScreening: 'Now screening',
    ...
    csvStep1: 'From a browser (not the app), go to <a href="https://letterboxd.com/settings/data/" target="_blank">letterboxd.com/settings/data</a>',
    ...
    lbSignInAction: 'Sign in',
    lbSignInSuffix: 'to upload your data and get personalized recommendations.',
    filmCount: (n: number) => `${n} film${n !== 1 ? 's' : ''}`,
    calendarHint: 'Click any poster for sessions, tickets and calendar options',
...
const KEYWORD_TRANSLATIONS_ES: Record<string, string> = {
  ...
  'based on comic': 'basado en cómic',
  'based on play or musical': 'basado en obra de teatro',
  'based on short story': 'basado en relato',
  'coming of age': 'madurez',
  'friendship': 'amistad',
  'female friendship': 'amistad femenina',
  'male friendship': 'amistad masculina',
  'unlikely friendship': 'amistad inesperada',
  'murder': 'asesinato',
  ...
  'husband wife relationship': 'relación de pareja',
  ...
  'psychological drama': 'drama psicológico',
  'neo-noir': 'neo-noir',
  'film noir': 'cine negro',
  ...
  'fight': 'pelea',
  'crime': 'crimen',
  'dream sequence': 'secuencia onírica',
  'nightmare': 'pesadilla',
  ...
  'nonlinear timeline': 'línea temporal no lineal',
