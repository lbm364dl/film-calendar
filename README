Script to fetch movies from Spanish theaters and generate a CSV with their Letterboxd link and rating to make the process of choosing a movie to watch easier. Still work in progress.
